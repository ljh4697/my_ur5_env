...
if __name__ == "__main__":
    ...
    r_last_position, pose_goal, plan = planning_ur5e.pose_plan_path(object_pose=box_position)
    ...
    planning_scene_1.set_joint_state_to_neutral_pose(neutral_pose=r_last_position)
    planning_scene_1._update_planning_scene(planning_scene_1.get_planning_scene)
    r_last_position, pose_goal, plan = planning_ur5e.pose_plan_path(object_pose=place_position)
