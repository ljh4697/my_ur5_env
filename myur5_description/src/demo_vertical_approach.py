...
def copy_pose(pose:geometry_msgs.msg.Pose()):
    ...
    copied_pose.position.z = pose.position.z-0.15
...
if __name__ == "__main__":
    ...
    while True:
        if separated_task == 0: # approach
            r_last_position, pose_goal, plan = planning_ur5e.pose_plan_path(object_pose=goal, approach_direction="vertical")
