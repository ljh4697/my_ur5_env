...
from avoid_visualize import visualization
...
if __name__ == "__main__":
    ...
    ap.add_argument('-b', "--num-batch", type=int, default=10,
                    help="# of batch")
    ap.add_argument('-s' ,'--seed',  type=int, default=3, help='A random seed')
    ...
    #'simulated'
    md = 'simulated'
    algo, true_w = define_algo(task, algos_type, args, md)
    ...
    while t < N:
        ...
        if int(t) in [20, 70, 90, 120, 150, 170, 190, 240, 300, 400]:
